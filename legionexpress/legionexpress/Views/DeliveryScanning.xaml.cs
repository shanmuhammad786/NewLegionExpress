...
namespace legionexpress.Views
{
    ...
    public partial class DeliveryScanning : ContentPage
    {
        DeliveryScanningViewModel viewModel;

        public DeliveryScanning()
        {
            InitializeComponent();
            viewModel = new DeliveryScanningViewModel(Navigation);
